#quick sort algorithm that sorts array labeled "Array", whose size is stored in "size"
.data
...
continue:
    	...
    	la $s0, 0
print:
		lw $a0, 28($t0) # get the number at that spot
        bgt $s0, 7, exit  # exit
        ...
        add $t0, $t0, -4 # increment $t0 for next address
        add $s0, $s0, 1
    	j print # goto print
exit:
	jr $ra